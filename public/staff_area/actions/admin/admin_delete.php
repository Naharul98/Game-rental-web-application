...
//retrieve associative array of admin according to id in the GET
        ...
        <section class="search-banner bg-light text-black py-5" id="search-banner">    
            <div class="container pt-0 my-0">
                <div class="row text-center pb-4">
                    <div class="col-lg-12">
                        <h2>Are you sure you want to delete the following Staff?</h2>
                        <br/>
                        <h3><?php echo $subject['Staff_Name'];?></h3>
                    </div>
                </div>                      
                <form action="<?php echo urlFor('/staff_area/actions/admin/admin_delete.php?id=' . h(u($subject['Staff_ID']))); ?>" method="POST" class="form-inline" >
                    <div class="container-fluid">
                        <div class="row">
                            <div class="span6" style="float: none; margin: 0 auto;">
                                ...
                                <a href="<?php echo urlFor('/staff_area/pages/admin_pages/admin_browse.php'); ?>" class="btn btn-lg active" style="background-color:#2d3246; color :white" role="button " aria-pressed="true">No</a>
                            </div>
                        </div>
                    </div>
                </form>
